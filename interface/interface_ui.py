...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.study_grid.addWidget(self.device_duty_checkbox, 1, 0, 1, 1)
        ...
        self.study_grid.addWidget(self.arc_flash_checkbox, 2, 0, 1, 1)
        self.placeholder_checkbox = QtWidgets.QCheckBox(self.study_group)
        self.placeholder_checkbox.setObjectName("placeholder_checkbox")
        self.study_grid.addWidget(self.placeholder_checkbox, 3, 0, 1, 1)
        ...
        self.exclude_revisions_input = QtWidgets.QLineEdit(self.arc_flash_layout)
        self.exclude_revisions_input.setEnabled(True)
        self.exclude_revisions_input.setMinimumSize(QtCore.QSize(0, 24))
        self.exclude_revisions_input.setObjectName("exclude_revisions_input")
        self.arc_flash_grid.addWidget(self.exclude_revisions_input, 2, 2, 1, 1)
        ...
        self.exclude_revisions_layout = QtWidgets.QHBoxLayout()
        self.exclude_revisions_layout.setObjectName("exclude_revisions_layout")
        self.exclude_none_radio = QtWidgets.QRadioButton(self.arc_flash_layout)
        self.exclude_none_radio.setEnabled(False)
        self.exclude_none_radio.setChecked(True)
        self.exclude_none_radio.setObjectName("exclude_none_radio")
        self.exclude_revisions_layout.addWidget(self.exclude_none_radio)
        self.exclude_all_radio = QtWidgets.QRadioButton(self.arc_flash_layout)
        self.exclude_all_radio.setEnabled(False)
        self.exclude_all_radio.setChecked(False)
        self.exclude_all_radio.setObjectName("exclude_all_radio")
        self.exclude_revisions_layout.addWidget(self.exclude_all_radio)
        self.exclude_only_radio = QtWidgets.QRadioButton(self.arc_flash_layout)
        self.exclude_only_radio.setEnabled(False)
        self.exclude_only_radio.setObjectName("exclude_only_radio")
        self.exclude_revisions_layout.addWidget(self.exclude_only_radio)
        spacerItem2 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.exclude_revisions_layout.addItem(spacerItem2)
        self.arc_flash_grid.addLayout(self.exclude_revisions_layout, 1, 2, 1, 1)
        self.exclude_revisions_label = QtWidgets.QLabel(self.arc_flash_layout)
        self.exclude_revisions_label.setObjectName("exclude_revisions_label")
        self.arc_flash_grid.addWidget(self.exclude_revisions_label, 1, 1, 1, 1)
        ...
        self.exclude_only_radio.toggled['bool'].connect(self.exclude_revisions_input.setVisible) # type: ignore
        self.create_scenarios_checkbox.toggled['bool'].connect(self.exclude_none_radio.setEnabled) # type: ignore
        self.create_scenarios_checkbox.toggled['bool'].connect(self.exclude_all_radio.setEnabled) # type: ignore
        self.create_scenarios_checkbox.toggled['bool'].connect(self.exclude_only_radio.setEnabled) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.exclude_revisions_input.setPlaceholderText(_translate("MainWindow", "Revisions to include in Create Scenarios..."))
        ...
        self.exclude_none_radio.setText(_translate("MainWindow", "None"))
        self.exclude_all_radio.setText(_translate("MainWindow", "All"))
        self.exclude_only_radio.setText(_translate("MainWindow", "All Except"))
        self.exclude_revisions_label.setText(_translate("MainWindow", "Exclude Revisions:"))
