...
import collections
import openpyxl
from etap.reports.Formats1800 import TDULFReportsCommons as comms


def load_events_data(wb, ws, cursor, table_names_list):
    # Getting all data from track node results table
    ...
    db_column_name_list = [description[0] for description in cursor.description]    
    ...
    excel_column_name_to_coordinates = comms.get_excelName_to_coordinates_dict(wb, db_column_name_list)    
    ...
    first_row_style["TDEvents_EventID"] = ws[comms.get_updated_coordinates(coordinates_for_EventID)]._style
    first_row_style["TDEvents_Time"] = ws[comms.get_updated_coordinates(coordinates_for_Time)]._style
    first_row_style["TDEvents_Date"] = ws[comms.get_updated_coordinates(coordinates_for_Date)]._style
    first_row_style["TDEvents_DeviceType"] = ws[comms.get_updated_coordinates(coordinates_for_DeviceType)]._style
    first_row_style["TDEvents_DeviceID"] = ws[comms.get_updated_coordinates(coordinates_for_DeviceID)]._style
    first_row_style["TDEvents_Action"] = ws[comms.get_updated_coordinates(coordinates_for_Action)]._style
    first_row_style["TDEvents_ActionPercent"] = ws[comms.get_updated_coordinates(coordinates_for_ActionPercent)]._style
    first_row_style["TDEvents_ActionTime"] = ws[comms.get_updated_coordinates(coordinates_for_ActionTime)]._style
       
    for i in range(0, total_rows_in_db):
        ws[coordinates_for_EventID]._style = copy(first_row_style["TDEvents_EventID"])
        ws[coordinates_for_EventID] = sql_all_rows_data[i][1]
        coordinates_for_EventID = comms.get_updated_coordinates(coordinates_for_EventID)
    
        ws[coordinates_for_Time]._style = copy(first_row_style["TDEvents_Time"])
        ws[coordinates_for_Time] = sql_all_rows_data[i][2].split(None, 1)[1]
        coordinates_for_Time = comms.get_updated_coordinates(coordinates_for_Time)
        
        ws[coordinates_for_Date]._style = copy(first_row_style["TDEvents_Date"])
        ws[coordinates_for_Date] = sql_all_rows_data[i][2].split(None,1)[0]
        coordinates_for_Date = comms.get_updated_coordinates(coordinates_for_Date)
    
        ws[coordinates_for_DeviceType]._style = copy(first_row_style["TDEvents_DeviceType"])
        ws[coordinates_for_DeviceType] = sql_all_rows_data[i][3]
        coordinates_for_DeviceType = comms.get_updated_coordinates(coordinates_for_DeviceType)
    
        ws[coordinates_for_DeviceID]._style = copy(first_row_style["TDEvents_DeviceID"])
        ws[coordinates_for_DeviceID] = sql_all_rows_data[i][4]
        coordinates_for_DeviceID = comms.get_updated_coordinates(coordinates_for_DeviceID)
        
        ws[coordinates_for_Action]._style = copy(first_row_style["TDEvents_Action"])
        ws[coordinates_for_Action] = sql_all_rows_data[i][5]
        coordinates_for_Action = comms.get_updated_coordinates(coordinates_for_Action)
    
        ws[coordinates_for_ActionPercent]._style = copy(first_row_style["TDEvents_ActionPercent"])
        ws[coordinates_for_ActionPercent] = sql_all_rows_data[i][7]
        coordinates_for_ActionPercent = comms.get_updated_coordinates(coordinates_for_ActionPercent)
        
        ws[coordinates_for_ActionTime]._style = copy(first_row_style["TDEvents_ActionTime"])
        ws[coordinates_for_ActionTime] = sql_all_rows_data[i][8]
        coordinates_for_ActionTime = comms.get_updated_coordinates(coordinates_for_ActionTime)
...
def load_device_profile_data(wb, ws, cursor, table_names_list):
    ...
    coordinates_for_OutofServiceDate = excel_column_name_to_coordinates["DeviceProfile_OutofServiceDate"]
    coordinates_for_GrowthCurve = excel_column_name_to_coordinates["DeviceProfile_GrowthCurve"]
    coordinates_for_DateGapOptions = excel_column_name_to_coordinates["DeviceProfile_DateGapOptions"]
    
    # Storing style of each cell in the second row in a dictionary. 
    second_row_style = dict() # {"range_string":cell_style}
    second_row_style["DeviceProfile_DeviceName"] = ws[(coordinates_for_deviceID)]._style
    second_row_style["DeviceProfile_DeviceType"] = ws[(coordinates_for_deviceType)]._style
    second_row_style["DeviceProfile_DataType"] = ws[(coordinates_for_dataType)]._style
    second_row_style["DeviceProfile_Type1"] = ws[(coordinates_for_type1)]._style
    second_row_style["DeviceProfile_Type2"] = ws[(coordinates_for_type2)]._style
    second_row_style["DeviceProfile_EnergizeDate"] = ws[(coordinates_for_energizeDate)]._style
    second_row_style["DeviceProfile_OutofServiceDate"] = ws[(coordinates_for_OutofServiceDate)]._style
    second_row_style["DeviceProfile_GrowthCurve"] = ws[(coordinates_for_GrowthCurve)]._style
    second_row_style["DeviceProfile_DateGapOptions"] = ws[(coordinates_for_DateGapOptions)]._style
    
    
    
    for i in range(0, total_rows_in_db):
    
        ws[coordinates_for_deviceID]._style = copy(second_row_style["DeviceProfile_DeviceName"])
        ws[coordinates_for_deviceID] = sql_all_rows_data[i][2]
        coordinates_for_deviceID = comms.get_updated_coordinates(coordinates_for_deviceID)
        
    
        ws[coordinates_for_deviceType]._style = copy(second_row_style["DeviceProfile_DeviceType"])
        ws[coordinates_for_deviceType] = sql_all_rows_data[i][3]
        coordinates_for_deviceType = comms.get_updated_coordinates(coordinates_for_deviceType)
    
    
        ws[coordinates_for_dataType]._style = copy(second_row_style["DeviceProfile_DataType"])
        ws[coordinates_for_dataType] = sql_all_rows_data[i][4]
        coordinates_for_dataType = comms.get_updated_coordinates(coordinates_for_dataType)
    
    
        ws[coordinates_for_type1]._style = copy(second_row_style["DeviceProfile_Type1"])
        ws[coordinates_for_type1] = sql_all_rows_data[i][5]
        coordinates_for_type1 = comms.get_updated_coordinates(coordinates_for_type1)
    
    
        ws[coordinates_for_type2]._style = copy(second_row_style["DeviceProfile_Type2"])
        ws[coordinates_for_type2] = sql_all_rows_data[i][6]
        coordinates_for_type2 = comms.get_updated_coordinates(coordinates_for_type2)
    
    
        ws[coordinates_for_energizeDate]._style = copy(second_row_style["DeviceProfile_EnergizeDate"])
        energize_date_value = sql_all_rows_data[i][7]
        energize_date_final = datetime.strptime(energize_date_value, '%Y-%m-%d').date()
        ws[coordinates_for_energizeDate] = energize_date_final.strftime('%x')
        coordinates_for_energizeDate = comms.get_updated_coordinates(coordinates_for_energizeDate)
    
        ws[coordinates_for_OutofServiceDate]._style = copy(second_row_style["DeviceProfile_OutofServiceDate"])
        outOfServiceDate_date_value = sql_all_rows_data[i][8]
        outOfServiceDate_date_final = datetime.strptime(outOfServiceDate_date_value, '%Y-%m-%d').date()
        ws[coordinates_for_OutofServiceDate] = outOfServiceDate_date_final.strftime('%x')
        coordinates_for_OutofServiceDate = comms.get_updated_coordinates(coordinates_for_OutofServiceDate)
    
    
        ws[coordinates_for_GrowthCurve]._style = copy(second_row_style["DeviceProfile_GrowthCurve"])
        ws[coordinates_for_GrowthCurve] = sql_all_rows_data[i][9]
        coordinates_for_GrowthCurve = comms.get_updated_coordinates(coordinates_for_GrowthCurve)
        ...
        ws[coordinates_for_DateGapOptions]._style = copy(second_row_style["DeviceProfile_DateGapOptions"])
        ws[coordinates_for_DateGapOptions] = dataGapOptionsFinal
        coordinates_for_DateGapOptions = comms.get_updated_coordinates(coordinates_for_DateGapOptions)
...
def load_alert_data(wb, ws, cursor, table_names_list):
    ...
    db_column_name_list = [description[0] for description in cursor.description]    
    resultID_to_timestamp_dict = get_time_stamp_from_result_id(table_names_list, cursor)
    ...
    second_row_style["Alerts_DeviceType"] = ws[(coordinates_for_deviceType)]._style
    second_row_style["Alerts_Rated"] = ws[(coordinates_for_rated)]._style
    second_row_style["Alerts_Unit"] = ws[(coordinates_for_unit)]._style
    second_row_style["Alerts_DeviationA"] = ws[(coordinates_for_deviationA)]._style
    second_row_style["Alerts_DeviationB"] = ws[(coordinates_for_deviationB)]._style
    second_row_style["Alerts_DeviationC"] = ws[(coordinates_for_deviationC)]._style
    second_row_style["Alerts_Condition"] = ws[(coordinates_for_condition)]._style
    second_row_style["Alerts_AlertType"] = ws[(coordinates_for_alertType)]._style
    ...
    for i in range(0, total_rows_in_db):
        ...
        ws[coordinates_for_date] = date_final.strftime('%x')
        coordinates_for_date = comms.get_updated_coordinates(coordinates_for_date)
    
    
        ws[coordinates_for_deviceID]._style = copy(second_row_style["Alerts_DeviceID"])
        ws[coordinates_for_deviceID] = sql_all_rows_data[i][2]
        coordinates_for_deviceID = comms.get_updated_coordinates(coordinates_for_deviceID)
        
    
        ws[coordinates_for_deviceType]._style = copy(second_row_style["Alerts_DeviceType"])
        ws[coordinates_for_deviceType] = sql_all_rows_data[i][3]
        coordinates_for_deviceType = comms.get_updated_coordinates(coordinates_for_deviceType)
    
    
        ws[coordinates_for_rated]._style = copy(second_row_style["Alerts_Rated"])
        ws[coordinates_for_rated] = sql_all_rows_data[i][6]
        coordinates_for_rated = comms.get_updated_coordinates(coordinates_for_rated)
    
    
        ws[coordinates_for_unit]._style = copy(second_row_style["Alerts_Unit"])
        ws[coordinates_for_unit] = sql_all_rows_data[i][5]
        coordinates_for_unit = comms.get_updated_coordinates(coordinates_for_unit)
    
    
        ws[coordinates_for_deviationA]._style = copy(second_row_style["Alerts_DeviationA"])
        ws[coordinates_for_deviationA] = sql_all_rows_data[i][10]
        coordinates_for_deviationA = comms.get_updated_coordinates(coordinates_for_deviationA)
    
    
        ws[coordinates_for_deviationB]._style = copy(second_row_style["Alerts_DeviationB"])
        ws[coordinates_for_deviationB] = sql_all_rows_data[i][11]
        coordinates_for_deviationB = comms.get_updated_coordinates(coordinates_for_deviationB)
    
        ws[coordinates_for_deviationC]._style = copy(second_row_style["Alerts_DeviationC"])
        ws[coordinates_for_deviationC] = sql_all_rows_data[i][12]
        coordinates_for_deviationC = comms.get_updated_coordinates(coordinates_for_deviationC)
    
    
        ws[coordinates_for_condition]._style = copy(second_row_style["Alerts_Condition"])
        ws[coordinates_for_condition] = sql_all_rows_data[i][13]
        coordinates_for_condition = comms.get_updated_coordinates(coordinates_for_condition)
            
    
        ws[coordinates_for_alertType]._style = copy(second_row_style["Alerts_AlertType"])
        ws[coordinates_for_alertType] = sql_all_rows_data[i][14]
        coordinates_for_alertType = comms.get_updated_coordinates(coordinates_for_alertType)
...
def load_loading_worst_case_data(wb, ws, cursor, table_names_list):
    ...
    coordinates_for_loadingA = excel_column_name_to_coordinates["LoadWorstCase_MaxBranchLoadingPhA"]
    coordinates_for_loadingB = excel_column_name_to_coordinates["LoadWorstCase_MaxBranchLoadingPhB"]
    coordinates_for_loadingC = excel_column_name_to_coordinates["LoadWorstCase_MaxBranchLoadingPhC"]
    ...
    second_row_style["LoadWorstCase_DeviceID"] = ws[comms.get_updated_coordinates(coordinates_for_deviceID)]._style
    second_row_style["LoadWorstCase_DeviceType"] = ws[comms.get_updated_coordinates(coordinates_for_deviceType)]._style
    second_row_style["LoadWorstCase_Capacity"] = ws[comms.get_updated_coordinates(coordinates_for_rated)]._style
    second_row_style["LoadWorstCase_Unit"] = ws[comms.get_updated_coordinates(coordinates_for_unit)]._style
    second_row_style["LoadWorstCase_MaxBranchLoadingPhA"] = ws[comms.get_updated_coordinates(coordinates_for_loadingA)]._style
    second_row_style["LoadWorstCase_MaxBranchLoadingPhB"] = ws[comms.get_updated_coordinates(coordinates_for_loadingB)]._style
    second_row_style["LoadWorstCase_MaxBranchLoadingPhC"] = ws[comms.get_updated_coordinates(coordinates_for_loadingC)]._style
    second_row_style["LoadWorstCase_Date"] = ws[comms.get_updated_coordinates(coordinates_for_date)]._style
    second_row_style["LoadWorstCase_Time"] = ws[comms.get_updated_coordinates(coordinates_for_time)]._style
    
    
    for i in range(0, total_rows_in_db):
    
        if sql_all_rows_data[i][1] != -1:
            ws[coordinates_for_deviceID]._style = copy(second_row_style["LoadWorstCase_DeviceID"])
            ws[coordinates_for_deviceID] = sql_all_rows_data[i][2]
            coordinates_for_deviceID = comms.get_updated_coordinates(coordinates_for_deviceID)
        
    
            ws[coordinates_for_deviceType]._style = copy(second_row_style["LoadWorstCase_DeviceType"])
            ws[coordinates_for_deviceType] = sql_all_rows_data[i][3]
            coordinates_for_deviceType = comms.get_updated_coordinates(coordinates_for_deviceType)
            
            if sql_all_rows_data[i][3] == "Two-winding Transformer" or sql_all_rows_data[i][3] == "Three-winding Transformer":
                ws[coordinates_for_unit]._style = copy(second_row_style["LoadWorstCase_Unit"])
                ws[coordinates_for_unit] = "kVA"
                coordinates_for_unit = comms.get_updated_coordinates(coordinates_for_unit)
    
                ws[coordinates_for_rated]._style = copy(second_row_style["LoadWorstCase_Capacity"])
            ...
            ws[coordinates_for_loadingA]._style = copy(second_row_style["LoadWorstCase_MaxBranchLoadingPhA"])
            ws[coordinates_for_loadingA] = sql_all_rows_data[i][5]
            coordinates_for_loadingA = comms.get_updated_coordinates(coordinates_for_loadingA)
    
    
            ws[coordinates_for_loadingB]._style = copy(second_row_style["LoadWorstCase_MaxBranchLoadingPhB"])
            ws[coordinates_for_loadingB] = sql_all_rows_data[i][6]
            coordinates_for_loadingB = comms.get_updated_coordinates(coordinates_for_loadingB)
        
            ws[coordinates_for_loadingC]._style = copy(second_row_style["LoadWorstCase_MaxBranchLoadingPhC"])
            ws[coordinates_for_loadingC] = sql_all_rows_data[i][7]
            coordinates_for_loadingC = comms.get_updated_coordinates(coordinates_for_loadingC)
            ...
            ws[coordinates_for_time]._style = copy(second_row_style["LoadWorstCase_Time"])
            ws[coordinates_for_time] = time_value
            coordinates_for_time = comms.get_updated_coordinates(coordinates_for_time)
    
    
            ws[coordinates_for_date]._style = copy(second_row_style["LoadWorstCase_Date"])
            ws[coordinates_for_date] = date_final.strftime('%x')
            coordinates_for_date = comms.get_updated_coordinates(coordinates_for_date)
    ...
    db_column_name_list_1 = [description[0] for description in cursor.description]
    
    resultID_to_timestamp_dict_1 = get_time_stamp_from_result_id(table_names_list, cursor)
...
def load_results_data(wb, ws, cursor, table_names_list):
    ...
    # Storing style of each cell in the second row in a dictionary. 
    second_row_style = dict() # {"range_string":cell_style}
    second_row_style["Results_Time"] = ws[comms.get_updated_coordinates(coordinates_for_time)]._style
    second_row_style["Results_Date"] = ws[comms.get_updated_coordinates(coordinates_for_date)]._style
    second_row_style["Results_TotalSourcekW"] = ws[comms.get_updated_coordinates(coordinates_for_totalkw)]._style
    second_row_style["Results_TotalSourcekvar"] = ws[comms.get_updated_coordinates(coordinates_for_totalkvar)]._style
    second_row_style["Results_TotalWindkW"] = ws[comms.get_updated_coordinates(coordinates_for_windkw)]._style
    second_row_style["Results_TotalSolarkW"] = ws[comms.get_updated_coordinates(coordinates_for_solarkw)]._style
    second_row_style["Results_TotalDCSourcekW"] = ws[comms.get_updated_coordinates(coordinates_for_dcSourcekw)]._style
    second_row_style["Results_TotalLoadkW"] = ws[comms.get_updated_coordinates(coordinates_for_totalLoadkw)]._style
    second_row_style["Results_TotalLoadkvar"] = ws[comms.get_updated_coordinates(coordinates_for_totalLoadkvar)]._style
    second_row_style["Results_TotalDCLoadkW"] = ws[comms.get_updated_coordinates(coordinates_for_totalDCLoadkw)]._style
    second_row_style["Results_TotalLosseskW"] = ws[comms.get_updated_coordinates(coordinates_for_totalLosseskW)]._style
    ...
    for i in range(0, total_rows_in_db):
        ...
        ws[coordinates_for_time]._style = copy(second_row_style["Results_Time"])
        ws[coordinates_for_time] = time_value
        coordinates_for_time = comms.get_updated_coordinates(coordinates_for_time)
    
    
        ws[coordinates_for_date]._style = copy(second_row_style["Results_Date"])
        ws[coordinates_for_date] = date_final.strftime('%x')
        coordinates_for_date = comms.get_updated_coordinates(coordinates_for_date)
    
    
        total_ac_load_kw = ((sql_all_rows_data[i][2] + sql_all_rows_data[i][3] + sql_all_rows_data[i][4])*1000)
        ws[coordinates_for_totalLoadkw]._style = copy(second_row_style["Results_TotalLoadkW"])
        ws[coordinates_for_totalLoadkw] = total_ac_load_kw
        coordinates_for_totalLoadkw = comms.get_updated_coordinates(coordinates_for_totalLoadkw)
        
    
        total_ac_load_kvar = ((sql_all_rows_data[i][5] + sql_all_rows_data[i][6] + sql_all_rows_data[i][7])*1000)
        ws[coordinates_for_totalLoadkvar]._style = copy(second_row_style["Results_TotalLoadkvar"])
        ws[coordinates_for_totalLoadkvar] = total_ac_load_kvar
        coordinates_for_totalLoadkvar = comms.get_updated_coordinates(coordinates_for_totalLoadkvar)
    
    
        total_ac_source_kw = ((sql_all_rows_data[i][8] + sql_all_rows_data[i][9] + sql_all_rows_data[i][10])*1000)
        ws[coordinates_for_totalkw]._style = copy(second_row_style["Results_TotalSourcekW"])
        ws[coordinates_for_totalkw] = total_ac_source_kw
        coordinates_for_totalkw = comms.get_updated_coordinates(coordinates_for_totalkw)
    
    
        total_ac_source_kvar = ((sql_all_rows_data[i][11] + sql_all_rows_data[i][12] + sql_all_rows_data[i][13])*1000)
        ws[coordinates_for_totalkvar]._style = copy(second_row_style["Results_TotalSourcekvar"])
        ws[coordinates_for_totalkvar] = total_ac_source_kvar
        coordinates_for_totalkvar = comms.get_updated_coordinates(coordinates_for_totalkvar)
    
    
        total_dc_load = (sql_all_rows_data[i][70]*1000)
        ws[coordinates_for_totalDCLoadkw]._style = copy(second_row_style["Results_TotalDCLoadkW"])
        ws[coordinates_for_totalDCLoadkw] = total_dc_load
        coordinates_for_totalDCLoadkw = comms.get_updated_coordinates(coordinates_for_totalDCLoadkw)
    
    
        total_dc_source = (sql_all_rows_data[i][71]*1000)
        ws[coordinates_for_dcSourcekw]._style = copy(second_row_style["Results_TotalDCSourcekW"])
        ws[coordinates_for_dcSourcekw] = total_dc_source
        coordinates_for_dcSourcekw = comms.get_updated_coordinates(coordinates_for_dcSourcekw)
        ...
        ws[coordinates_for_totalLosseskW]._style = copy(second_row_style["Results_TotalLosseskW"])
        ws[coordinates_for_totalLosseskW] = total_losses
        coordinates_for_totalLosseskW = comms.get_updated_coordinates(coordinates_for_totalLosseskW)
    
        ws[coordinates_for_windkw]._style = copy(second_row_style["Results_TotalWindkW"])
        ws[coordinates_for_windkw] = (sql_all_rows_data[i][72]*1000)
        coordinates_for_windkw = comms.get_updated_coordinates(coordinates_for_windkw)
    
    
        ws[coordinates_for_solarkw]._style = copy(second_row_style["Results_TotalSolarkW"])
        ws[coordinates_for_solarkw] = (sql_all_rows_data[i][73]*1000)
        coordinates_for_solarkw = comms.get_updated_coordinates(coordinates_for_solarkw)
...
def load_voltage_worst_case_data(wb, ws, cursor, table_names_list):
    ...
    coordinates_for_nomkV = excel_column_name_to_coordinates["PhaseVoltageWorstCase_DeviceNominalKV"]
    coordinates_for_connectionType = excel_column_name_to_coordinates["PhaseVoltageWorstCase_ConnectionType"]
    coordinates_for_maxVoltPhase = excel_column_name_to_coordinates["PhaseVoltageWorstCase_MaxVoltPhase"]
    coordinates_for_maxVoltValue = excel_column_name_to_coordinates["PhaseVoltageWorstCase_MaxVoltValue"]
    coordinates_for_maxVoltDate = excel_column_name_to_coordinates["PhaseVoltageWorstCase_MaxVoltDate"]
    coordinates_for_maxVoltTime = excel_column_name_to_coordinates["PhaseVoltageWorstCase_MaxVoltTime"]
    coordinates_for_minVoltPhase = excel_column_name_to_coordinates["PhaseVoltageWorstCase_MinVoltPhase"]
    coordinates_for_minVoltValue = excel_column_name_to_coordinates["PhaseVoltageWorstCase_MinVoltValue"]
    coordinates_for_minVoltDate = excel_column_name_to_coordinates["PhaseVoltageWorstCase_MinVoltDate"]
    coordinates_for_minVoltTime = excel_column_name_to_coordinates["PhaseVoltageWorstCase_MinVoltTime"]
    
    # Storing style of each cell in the second row in a dictionary. 
    second_row_style = dict() # {"range_string":cell_style}
    second_row_style["PhaseVoltageWorstCase_DeviceID"] = ws[comms.get_updated_coordinates(coordinates_for_deviceID)]._style
    second_row_style["PhaseVoltageWorstCase_DeviceNominalKV"] = ws[comms.get_updated_coordinates(coordinates_for_nomkV)]._style
    second_row_style["PhaseVoltageWorstCase_ConnectionType"] = ws[comms.get_updated_coordinates(coordinates_for_connectionType)]._style
    second_row_style["PhaseVoltageWorstCase_MaxVoltPhase"] = ws[comms.get_updated_coordinates(coordinates_for_maxVoltPhase)]._style
    second_row_style["PhaseVoltageWorstCase_MaxVoltValue"] = ws[comms.get_updated_coordinates(coordinates_for_maxVoltValue)]._style
    second_row_style["PhaseVoltageWorstCase_MaxVoltDate"] = ws[comms.get_updated_coordinates(coordinates_for_maxVoltDate)]._style
    second_row_style["PhaseVoltageWorstCase_MaxVoltTime"] = ws[comms.get_updated_coordinates(coordinates_for_maxVoltTime)]._style
    second_row_style["PhaseVoltageWorstCase_MinVoltPhase"] = ws[comms.get_updated_coordinates(coordinates_for_minVoltPhase)]._style
    second_row_style["PhaseVoltageWorstCase_MinVoltValue"] = ws[comms.get_updated_coordinates(coordinates_for_minVoltValue)]._style
    second_row_style["PhaseVoltageWorstCase_MinVoltDate"] = ws[comms.get_updated_coordinates(coordinates_for_minVoltDate)]._style
    second_row_style["PhaseVoltageWorstCase_MinVoltTime"] = ws[comms.get_updated_coordinates(coordinates_for_minVoltTime)]._style
    
    for i in range(0, total_rows_in_db):
    
        # Only adding data without result ID less than 0
        if sql_all_rows_data[i][15] > 0 or sql_all_rows_data[i][11] > 0:
            ws[coordinates_for_deviceID]._style = copy(second_row_style["PhaseVoltageWorstCase_DeviceID"])
            ws[coordinates_for_deviceID] = sql_all_rows_data[i][1]
            coordinates_for_deviceID = comms.get_updated_coordinates(coordinates_for_deviceID)  
            
            ws[coordinates_for_nomkV]._style = copy(second_row_style["PhaseVoltageWorstCase_DeviceNominalKV"])
            ws[coordinates_for_nomkV] = sql_all_rows_data[i][2]
            coordinates_for_nomkV = comms.get_updated_coordinates(coordinates_for_nomkV) 
    
            # Followig data is not available in database, thus defaulting value to LN
            ws[coordinates_for_connectionType]._style = copy(second_row_style["PhaseVoltageWorstCase_ConnectionType"])
            ws[coordinates_for_connectionType] = "LN"
            coordinates_for_connectionType = comms.get_updated_coordinates(coordinates_for_connectionType) 
            ...
            if sql_all_rows_data[i][11] > 0:
                ...
                ws[coordinates_for_maxVoltPhase]._style = copy(second_row_style["PhaseVoltageWorstCase_MaxVoltPhase"])
                ...
                coordinates_for_maxVoltPhase = comms.get_updated_coordinates(coordinates_for_maxVoltPhase) 
    
                # adding voltage value.
                ws[coordinates_for_maxVoltValue]._style = copy(second_row_style["PhaseVoltageWorstCase_MaxVoltValue"])
                ws[coordinates_for_maxVoltValue] = max_voltage/100
                coordinates_for_maxVoltValue = comms.get_updated_coordinates(coordinates_for_maxVoltValue) 
                ...
                ws[coordinates_for_maxVoltTime]._style = copy(second_row_style["PhaseVoltageWorstCase_MaxVoltTime"])
                ws[coordinates_for_maxVoltTime] = time_value
                coordinates_for_maxVoltTime = comms.get_updated_coordinates(coordinates_for_maxVoltTime)
    
                ws[coordinates_for_maxVoltDate]._style = copy(second_row_style["PhaseVoltageWorstCase_MaxVoltDate"])
                ws[coordinates_for_maxVoltDate] = date_final.strftime('%x')
                coordinates_for_maxVoltDate = comms.get_updated_coordinates(coordinates_for_maxVoltDate)
            ...
            if sql_all_rows_data[i][15] > 0:
                ...
                ws[coordinates_for_minVoltPhase]._style = copy(second_row_style["PhaseVoltageWorstCase_MinVoltPhase"])
                ...
                coordinates_for_minVoltPhase = comms.get_updated_coordinates(coordinates_for_minVoltPhase) 
    
                # adding voltage value.
                ws[coordinates_for_minVoltValue]._style = copy(second_row_style["PhaseVoltageWorstCase_MinVoltValue"])
                ws[coordinates_for_minVoltValue] = min_voltage/100
                coordinates_for_minVoltValue = comms.get_updated_coordinates(coordinates_for_minVoltValue) 
                ...
                ws[coordinates_for_minVoltTime]._style = copy(second_row_style["PhaseVoltageWorstCase_MinVoltTime"])
                ws[coordinates_for_minVoltTime] = time_value
                coordinates_for_minVoltTime = comms.get_updated_coordinates(coordinates_for_minVoltTime)
    
                ws[coordinates_for_minVoltDate]._style = copy(second_row_style["PhaseVoltageWorstCase_MinVoltDate"])
                ws[coordinates_for_minVoltDate] = date_final.strftime('%x')
                coordinates_for_minVoltDate = comms.get_updated_coordinates(coordinates_for_minVoltDate)
...
def load_summary_group_data(wb, ws, cursor, table_names_list):
    ...
    group_info_column_name_list = [description[0] for description in cursor.description]
    ...
    group_result_column_name_list = [description[0] for description in cursor.description]
    column_names = len(wb.defined_names.definedName)
    ...
    for i in range(0, column_names):
        try:
            excel_column_name = wb.defined_names.definedName[i].name
            actual_coordinates = next(wb.defined_names[excel_column_name].destinations)[1]
            first_emp_index = [i for i, ltr in enumerate(actual_coordinates) if ltr == '$'][0]
            second_emp_index = [i for i, ltr in enumerate(actual_coordinates) if ltr == '$'][1]
            column_alphabet = actual_coordinates[first_emp_index + 1:second_emp_index]
            ...
            start_writing_coordinate = actual_coordinates[:first_emp_index+1] + start_writing_column + actual_coordinates[second_emp_index:]
            excel_column_name_to_coordinates[excel_column_name] = start_writing_coordinate
        except KeyError:
            errors = '1'
            continue
    ...
    end_time_stamp = datetime.strptime((study_case_info_data[0][2]), '%m-%d-%Y %H:%M:%S')
    ...
    for group in range(0, number_of_groups):
        ...
        for i in range(0, len(data_for_current_group)):
            ...
            time_stamp_for_i = datetime.strptime(resultID_to_timestamp_dict[data_for_current_group[i][1]][0], '%m-%d-%Y %H:%M:%S')        
            ...
            if(i == len(data_for_current_group)-1):
                if(end_time_stamp != datetime.strptime(resultID_to_timestamp_dict[data_for_current_group[i][1]][0], '%m-%d-%Y %H:%M:%S')):
                    ...
                    time_stamp_for_i1 = datetime.strptime(resultID_to_timestamp_dict[data_for_current_group[i][1]][0], '%m-%d-%Y %H:%M:%S')
            else:
                time_stamp_for_i1 = datetime.strptime(resultID_to_timestamp_dict[data_for_current_group[i+1][1]][0], '%m-%d-%Y %H:%M:%S')

            duration = (time_stamp_for_i1 - time_stamp_for_i)
            duration_in_hours = (time_stamp_for_i1 - time_stamp_for_i).total_seconds()/3600


            total_AC_generation_for_i = data_for_current_group[i][9] + data_for_current_group[i][10] + data_for_current_group[i][11]
            ...
            total_AC_load_for_i = data_for_current_group[i][3] + data_for_current_group[i][4] + data_for_current_group[i][5]
        ...
        total_system_generation_energy = total_AC_generation_energy + total_solar_energy + total_wind_energy + total_DC_generation_energy
        ...
        average_demand = (sum(list_of_DC_total_load) + sum(list_of_AC_total_load)) / len(data_for_current_group)
        ...
        coordinates_for_maxWindGen_date = comms.increase_column_by_one(coordinates_for_maxWindGen)
        coordinates_for_maxWindGen_time = comms.increase_column_by_one(coordinates_for_maxWindGen_date)
        time_stamp_for_maxWindGen = wind_gen_to_time_stamp[max(list_of_wind_gen)]
        ws[coordinates_for_maxWindGen] = max(list_of_wind_gen)
        ws[coordinates_for_maxWindGen_date] = time_stamp_for_maxWindGen.date().strftime('%x')
        ...
        coordinates_for_maxSolarGen_date = comms.increase_column_by_one(coordinates_for_maxSolarGen)
        coordinates_for_maxSolarGen_time = comms.increase_column_by_one(coordinates_for_maxSolarGen_date)
        time_stamp_for_maxSolarGen = solar_gen_to_time_stamp[max(list_of_solar_gen)]
        ws[coordinates_for_maxSolarGen] = max(list_of_solar_gen)
        ws[coordinates_for_maxSolarGen_date] = time_stamp_for_maxSolarGen.date().strftime('%x')
        ...
        coordinates_for_maxTotalACGen_date = comms.increase_column_by_one(coordinates_for_maxTotalACGen)
        coordinates_for_maxTotalACGen_time = comms.increase_column_by_one(coordinates_for_maxTotalACGen_date)
        time_stamp_for_maxTotalACGen = AC_total_gen_to_time_stamp[max(list_of_AC_total_gen)]
        ws[coordinates_for_maxTotalACGen] = max(list_of_AC_total_gen)
        ws[coordinates_for_maxTotalACGen_date] = time_stamp_for_maxTotalACGen.date().strftime('%x')
        ...
        coordinates_for_maxTotalDCGen_date = comms.increase_column_by_one(coordinates_for_maxTotalDCGen)
        coordinates_for_maxTotalDCGen_time = comms.increase_column_by_one(coordinates_for_maxTotalDCGen_date)
        time_stamp_for_maxTotalDCGen = DC_total_gen_to_time_stamp[max(list_of_DC_total_gen)]
        ws[coordinates_for_maxTotalDCGen] = max(list_of_DC_total_gen)
        ws[coordinates_for_maxTotalDCGen_date] = time_stamp_for_maxTotalDCGen.date().strftime('%x')
        ws[coordinates_for_maxTotalDCGen_time] = time_stamp_for_maxTotalDCGen.time().strftime('%X')
     
        coordinates_for_maxTotalACLoad = excel_column_name_to_coordinates["GroupSummary_MaxACLoad"]
        coordinates_for_maxTotalACLoad_date = comms.increase_column_by_one(coordinates_for_maxTotalACLoad)
        coordinates_for_maxTotalACLoad_time = comms.increase_column_by_one(coordinates_for_maxTotalACLoad_date)
        time_stamp_for_maxTotalACLoad = AC_total_load_to_time_stamp[max(list_of_AC_total_load)]
        ws[coordinates_for_maxTotalACLoad] = max(list_of_AC_total_load)
        ws[coordinates_for_maxTotalACLoad_date] = time_stamp_for_maxTotalACLoad.date().strftime('%x')
        ws[coordinates_for_maxTotalACLoad_time] = time_stamp_for_maxTotalACLoad.time().strftime('%X')
        
        coordinates_for_maxTotalDCLoad = excel_column_name_to_coordinates["GroupSummary_MaxDCLoad"]
        coordinates_for_maxTotalDCLoad_date = comms.increase_column_by_one(coordinates_for_maxTotalDCLoad)
        coordinates_for_maxTotalDCLoad_time = comms.increase_column_by_one(coordinates_for_maxTotalDCLoad_date)
        time_stamp_for_maxTotalDCLoad = DC_total_load_to_time_stamp[max(list_of_DC_total_load)]
        ws[coordinates_for_maxTotalDCLoad] = max(list_of_DC_total_load)
        ws[coordinates_for_maxTotalDCLoad_date] = time_stamp_for_maxTotalDCLoad.date().strftime('%x')
        ws[coordinates_for_maxTotalDCLoad_time] = time_stamp_for_maxTotalDCLoad.time().strftime('%X')
...
def load_system_summary_data(wb, ws, cursor, table_names_list):
    ...
    for i in range(0, column_names):
        try:
            excel_column_name = wb.defined_names.definedName[i].name
            actual_coordinates = next(wb.defined_names[excel_column_name].destinations)[1]
            start_writing_coordinate = comms.increase_column_by_one(actual_coordinates)
            excel_column_name_to_coordinates[excel_column_name] = start_writing_coordinate
        except KeyError:
            errors = '1'
            continue    
    ...
    for j in range(0, total_rows_system_result):    
        ...
        Va_max_to_resultID_busID[system_result_data[j][14]] = [system_result_data[j][1], system_result_data[j][18]]    
        Va_min_list.append(system_result_data[j][24])
        Va_min_to_resultID_busID[system_result_data[j][24]] = [system_result_data[j][1], system_result_data[j][28]]
    
        Vb_max_list.append(system_result_data[j][15])
        Vb_max_to_resultID_busID[system_result_data[j][15]] = [system_result_data[j][1], system_result_data[j][18]]
        Vb_min_list.append(system_result_data[j][25])
        Vb_min_to_resultID_busID[system_result_data[j][25]] = [system_result_data[j][1], system_result_data[j][28]]
        
        Vc_max_list.append(system_result_data[j][16])
        Vc_max_to_resultID_busID[system_result_data[j][16]] = [system_result_data[j][1], system_result_data[j][18]]
        Vc_min_list.append(system_result_data[j][26])
        Vc_min_to_resultID_busID[system_result_data[j][26]] = [system_result_data[j][1], system_result_data[j][28]]

    # Generating data for energy calculation table:
    for i in range(0, total_rows_system_result):
        time_stamp_for_i = datetime.strptime(resultID_to_timestamp_dict[system_result_data[i][1]][0], '%m-%d-%Y %H:%M:%S')        
        ...
        if(i == total_rows_system_result-1):
            if(end_time_stamp != datetime.strptime(resultID_to_timestamp_dict[system_result_data[i][1]][0], '%m-%d-%Y %H:%M:%S')):
                ...
                time_stamp_for_i1 = datetime.strptime(resultID_to_timestamp_dict[system_result_data[i][1]][0], '%m-%d-%Y %H:%M:%S')
        else:
            time_stamp_for_i1 = datetime.strptime(resultID_to_timestamp_dict[system_result_data[i+1][1]][0], '%m-%d-%Y %H:%M:%S')

        duration = (time_stamp_for_i1 - time_stamp_for_i)
        duration_in_hours = (time_stamp_for_i1 - time_stamp_for_i).total_seconds()/3600

        total_AC_generation_for_i = system_result_data[i][8] + system_result_data[i][9] + system_result_data[i][10]
        total_AC_generation_energy += total_AC_generation_for_i * duration_in_hours
        list_of_AC_total_gen.append(total_AC_generation_for_i)
        AC_total_gen_to_time_stamp[total_AC_generation_for_i] = time_stamp_for_i
        ...
        total_AC_load_for_i = system_result_data[i][2] + system_result_data[i][3] + system_result_data[i][4]
        total_AC_load_energy += total_AC_load_for_i * duration_in_hours
        list_of_AC_total_load.append(total_AC_load_for_i)
        AC_total_load_to_time_stamp[total_AC_load_for_i] = time_stamp_for_i
    ...
    total_demand = (sum(list_of_DC_total_load) + sum(list_of_AC_total_load))/total_rows_system_result #replace len with total time steps
    ...
    ws[coordinates_for_maxVaBusID] = Va_max_to_resultID_busID[max(Va_max_list)][1]
    coordinates_for_maxVaMag = comms.increase_column_by_one(comms.increase_column_by_one(coordinates_for_maxVaBusID))
    ws[coordinates_for_maxVaMag] = max(Va_max_list)
    time_stamp_maxVa = resultID_to_timestamp_dict[Va_max_to_resultID_busID[max(Va_max_list)][0]][0]
    date_value_maxVaDate, time_value_maxVaTime = comms.date_and_time_from_timeStamp(time_stamp_maxVa)
    coordinates_for_maxVaDate = comms.increase_column_by_one(coordinates_for_maxVaMag)
    ws[coordinates_for_maxVaDate] = date_value_maxVaDate.strftime('%x')
    coordinates_for_maxVaTime = comms.increase_column_by_one(coordinates_for_maxVaDate)
    ...
    ws[coordinates_for_maxVbBusID] = Vb_max_to_resultID_busID[max(Vb_max_list)][1]
    coordinates_for_maxVbMag = comms.increase_column_by_one(comms.increase_column_by_one(coordinates_for_maxVbBusID))
    ws[coordinates_for_maxVbMag] = max(Vb_max_list)
    time_stamp_maxVb = resultID_to_timestamp_dict[Vb_max_to_resultID_busID[max(Vb_max_list)][0]][0]
    date_value_maxVbDate, time_value_maxVbTime = comms.date_and_time_from_timeStamp(time_stamp_maxVb)
    coordinates_for_maxVbDate = comms.increase_column_by_one(coordinates_for_maxVbMag)
    ws[coordinates_for_maxVbDate] = date_value_maxVbDate.strftime('%x')
    coordinates_for_maxVbTime = comms.increase_column_by_one(coordinates_for_maxVbDate)
    ...
    ws[coordinates_for_maxVcBusID] = Vc_max_to_resultID_busID[max(Vc_max_list)][1]
    coordinates_for_maxVcMag = comms.increase_column_by_one(comms.increase_column_by_one(coordinates_for_maxVcBusID))
    ws[coordinates_for_maxVcMag] = max(Vc_max_list)
    time_stamp_maxVc = resultID_to_timestamp_dict[Vc_max_to_resultID_busID[max(Vc_max_list)][0]][0]
    date_value_maxVcDate, time_value_maxVcTime = comms.date_and_time_from_timeStamp(time_stamp_maxVc)
    coordinates_for_maxVcDate = comms.increase_column_by_one(coordinates_for_maxVcMag)
    ws[coordinates_for_maxVcDate] = date_value_maxVcDate.strftime('%x')
    coordinates_for_maxVcTime = comms.increase_column_by_one(coordinates_for_maxVcDate)
    ...
    ws[coordinates_for_minVaBusID] = Va_min_to_resultID_busID[min(Va_min_list)][1]
    coordinates_for_minVaMag = comms.increase_column_by_one(comms.increase_column_by_one(coordinates_for_minVaBusID))
    ws[coordinates_for_minVaMag] = max(Va_min_list)
    time_stamp_minVa = resultID_to_timestamp_dict[Va_min_to_resultID_busID[min(Va_min_list)][0]][0]
    date_value_minVaDate, time_value_minVaTime = comms.date_and_time_from_timeStamp(time_stamp_minVa)
    coordinates_for_minVaDate = comms.increase_column_by_one(coordinates_for_minVaMag)
    ws[coordinates_for_minVaDate] = date_value_minVaDate.strftime('%x')
    coordinates_for_minVaTime = comms.increase_column_by_one(coordinates_for_minVaDate)
    ...
    ws[coordinates_for_minVbBusID] = Vb_min_to_resultID_busID[min(Vb_min_list)][1]
    coordinates_for_minVbMag = comms.increase_column_by_one(comms.increase_column_by_one(coordinates_for_minVbBusID))
    ws[coordinates_for_minVbMag] = max(Vb_min_list)
    time_stamp_minVb = resultID_to_timestamp_dict[Vb_min_to_resultID_busID[min(Vb_min_list)][0]][0]
    date_value_minVbDate, time_value_minVbTime = comms.date_and_time_from_timeStamp(time_stamp_minVb)
    coordinates_for_minVbDate = comms.increase_column_by_one(coordinates_for_minVbMag)
    ws[coordinates_for_minVbDate] = date_value_minVbDate.strftime('%x')
    coordinates_for_minVbTime = comms.increase_column_by_one(coordinates_for_minVbDate)
    ...
    ws[coordinates_for_minVcBusID] = Vc_min_to_resultID_busID[max(Vc_min_list)][1]
    coordinates_for_minVcMag = comms.increase_column_by_one(comms.increase_column_by_one(coordinates_for_minVcBusID))
    ws[coordinates_for_minVcMag] = max(Vc_min_list)
    time_stamp_minVc = resultID_to_timestamp_dict[Vc_min_to_resultID_busID[min(Vc_min_list)][0]][0]
    date_value_minVcDate, time_value_minVcTime = comms.date_and_time_from_timeStamp(time_stamp_minVc)
    coordinates_for_minVcDate = comms.increase_column_by_one(coordinates_for_minVcMag)
    ws[coordinates_for_minVcDate] = date_value_minVcDate.strftime('%x')
    coordinates_for_minVcTime = comms.increase_column_by_one(coordinates_for_minVcDate)
    ...
    for i in range(0, len(defined_names_for_project_info)):
        try:
            ...
            if info_excel_column_name ==  "Cover_PSRev":
                info_start_writing_coordinate = comms.get_updated_coordinates(info_actual_coordinates)
            else:
                info_start_writing_coordinate = comms.increase_column_by_one(info_actual_coordinates)
...
def load_study_info_data(wb, ws, cursor, table_names_list):
    ...
    for i in range(0, len(defined_names_for_project_info)):
        try:
            ...
            if (info_excel_column_name == "Info_ConstP" or info_excel_column_name == "Info_ConstZ" or info_excel_column_name == "Info_ConstI" or info_excel_column_name == "Info_ConstGen"):
                ...
                info_actual_coordinates = next(wb.defined_names[info_excel_column_name].destinations)[1]
                info_start_writing_coordinate = comms.increase_column_by_one(comms.increase_column_by_one(comms.increase_column_by_one(comms.increase_column_by_one(comms.increase_column_by_one(info_actual_coordinates)))))
                excel_column_name_to_coordinates_info[info_excel_column_name] = info_start_writing_coordinate
        except KeyError:
            errors = '1'
            continue
    ...
    coordinates_for_solPrecision = excel_column_name_to_coordinates_info["Info_SolutionPrecision"]
    ws[coordinates_for_solPrecision] = study_case_info_data[0][14]

    coordinates_for_haltNonConverge = excel_column_name_to_coordinates_info["Info_HaltNonConverge"]
    ws[coordinates_for_haltNonConverge] = comms.is_tolerance_applied(study_case_info_data[0][15])

    coordinates_for_haltEquipOverLoad = excel_column_name_to_coordinates_info["Info_HaltEquipOverLoad"]
    ws[coordinates_for_haltEquipOverLoad] = comms.is_tolerance_applied(study_case_info_data[0][16])
    
    coordinates_for_aCDCSimSolution = excel_column_name_to_coordinates_info["Info_ACDCSimSolution"]
    ws[coordinates_for_aCDCSimSolution] = comms.is_tolerance_applied(study_case_info_data[0][17])
    ...
    coordinates_for_chargerLoading = excel_column_name_to_coordinates_info["Info_ChargerLoading"]
    ...
    simulation_start_time = simulation_start_time_stamp[simulation_start_time_stamp.find(' ')+1:]
    simulation_start_date_final = datetime.strptime(simulation_start_date, '%m-%d-%Y').date()
    ...
    simulation_stop_time = simulation_stop_time_stamp[simulation_stop_time_stamp.find(' ')+1:]
    simulation_stop_date_final = datetime.strptime(simulation_stop_date, '%m-%d-%Y').date()
    
    coordinates_for_simStartDate = excel_column_name_to_coordinates_info["Info_SimStartTime"]
    ws[coordinates_for_simStartDate] = simulation_start_date_final.strftime('%x')

    coordinates_for_simStartTime = comms.increase_column_by_one(coordinates_for_simStartDate)
    ...
    ws[coordinates_for_simStopDate] = simulation_stop_date_final.strftime('%x')
    
    coordinates_for_simStartTime = comms.increase_column_by_one(coordinates_for_simStopDate)
    ...
    coordinates_for_simStepUnit = comms.increase_column_by_one(coordinates_for_simStepValue)
    ...
    ws[coordinates_for_externalData] = comms.is_tolerance_applied(study_case_info_data[0][39])
    ...
    coordinates_for_windExternalData = excel_column_name_to_coordinates_info["Info_WindExternalData"]
    ...
    coordinates_for_pVExternalData = excel_column_name_to_coordinates_info["Info_PVExternalData"]
    ws[coordinates_for_pVExternalData] = pv_external_data_final
    
    coordinates_for_annualLoadGrowth = excel_column_name_to_coordinates_info["Info_AnnualLoadGrowthFactor"]
    ws[coordinates_for_annualLoadGrowth] = study_case_info_data[0][42]
    
    coordinates_for_applyNegTolMinTemp = excel_column_name_to_coordinates_info["Info_ApplyNegTolMinTemp"]
    # ++[JaykumarD] 2018/07/13 IR-53983 - TDULF, Report, 3 issues found with Excel report, ETAP version headr and adjustment info are wrong
    #ws[coordinates_for_applyNegTolMinTemp] = comms.is_tolerance_applied(study_case_info_data[0][43])
    ws[coordinates_for_applyNegTolMinTemp] = comms.is_tolerance_applied(study_case_info_data[0][64])
    
    coordinates_for_xmerZTol = excel_column_name_to_coordinates_info["Info_XmerZTol"]
    ws[coordinates_for_xmerZTol] = comms.is_tolerance_applied(study_case_info_data[0][43])
    
    coordinates_for_xmerZTolIndGob = comms.increase_column_by_one(coordinates_for_xmerZTol)
    ws[coordinates_for_xmerZTolIndGob] = comms.apply_global_or_indivudual_tolerance(study_case_info_data[0][44])
    
    coordinates_for_xmerZTolPercent = comms.increase_column_by_one(coordinates_for_xmerZTolIndGob)
    ...
    ws[coordinates_for_xmerXTol] = comms.is_tolerance_applied(study_case_info_data[0][61])
    
    coordinates_for_xmerXTolIndGob = comms.increase_column_by_one(coordinates_for_xmerXTol)
    ws[coordinates_for_xmerXTolIndGob] = comms.apply_global_or_indivudual_tolerance(study_case_info_data[0][62])
    
    coordinates_for_xmerXTolPercent = comms.increase_column_by_one(coordinates_for_xmerXTolIndGob)
    ...
    ws[coordinates_for_oLHResistance] = comms.is_tolerance_applied(study_case_info_data[0][52])

    coordinates_for_oLHResistanceIndGob = comms.increase_column_by_one(coordinates_for_oLHResistance)
    ws[coordinates_for_oLHResistanceIndGob] = comms.apply_global_or_indivudual_tolerance(study_case_info_data[0][53])
    
    coordinates_for_oLHResistancePercent = comms.increase_column_by_one(coordinates_for_oLHResistanceIndGob)
    ...
    ws[coordinates_for_lineLength] = comms.is_tolerance_applied(study_case_info_data[0][46])
    
    coordinates_for_lineLengthIndGob = comms.increase_column_by_one(coordinates_for_lineLength)
    ws[coordinates_for_lineLengthIndGob] = comms.apply_global_or_indivudual_tolerance(study_case_info_data[0][47])
    
    coordinates_for_lineLengthPercent = comms.increase_column_by_one(coordinates_for_lineLengthIndGob)
    ...
    ws[coordinates_for_cableLength] = comms.is_tolerance_applied(study_case_info_data[0][49])
    
    coordinates_for_cableLengthIndGob = comms.increase_column_by_one(coordinates_for_cableLength)
    ws[coordinates_for_cableLengthIndGob] = comms.apply_global_or_indivudual_tolerance(study_case_info_data[0][50])
    
    coordinates_for_cableLengthPercent = comms.increase_column_by_one(coordinates_for_cableLengthIndGob)
    ws[coordinates_for_cableLengthPercent] = study_case_info_data[0][51]
    
    coordinates_for_lineResistance = excel_column_name_to_coordinates_info["Info_LineResistance"]
    ws[coordinates_for_lineResistance] = comms.is_tolerance_applied(study_case_info_data[0][55])
        
    coordinates_for_lineResistanceIndGob = comms.increase_column_by_one(coordinates_for_lineResistance)
    ws[coordinates_for_lineResistanceIndGob] = comms.apply_global_or_indivudual_tolerance(study_case_info_data[0][56])
    
    coordinates_for_lineResistancePercent = comms.increase_column_by_one(coordinates_for_lineResistanceIndGob)
    ws[coordinates_for_lineResistancePercent] = study_case_info_data[0][57]
    
    coordinates_for_cableResistance = excel_column_name_to_coordinates_info["Info_CableResistance"]
    ws[coordinates_for_cableResistance] = comms.is_tolerance_applied(study_case_info_data[0][58])
    
    coordinates_for_cableResistanceIndGob = comms.increase_column_by_one(coordinates_for_cableResistance)
    ws[coordinates_for_cableResistanceIndGob] = comms.apply_global_or_indivudual_tolerance(study_case_info_data[0][59])
    
    coordinates_for_cableResistancePercent = comms.increase_column_by_one(coordinates_for_cableResistanceIndGob)
    ...
    coordinates_for_haltingCalcUnsolved = excel_column_name_to_coordinates_info["Info_HaltingCalcUnsolved"]
    ...
    calcStart_time_value = calcStart_time_stamp[calcStart_time_stamp.find(' ')+1:]
    calcStart_date_final = datetime.strptime(calcStart_date_value, '%m-%d-%Y').date()
    ...
    calcStop_date_final = datetime.strptime(calcStop_date_value, '%m-%d-%Y').date()


    coordinates_for_calcStartDate = excel_column_name_to_coordinates_info["Info_CalcStartDate"]
    ws[coordinates_for_calcStartDate] = calcStart_date_final.strftime('%x')
    
    coordinates_for_calcStartTime = comms.increase_column_by_one(coordinates_for_calcStartDate)
    ...
    ws[coordinates_for_calcStopDate] = calcStop_date_final.strftime('%x')
    
    coordinates_for_calcStopTime = comms.increase_column_by_one(coordinates_for_calcStopDate)
